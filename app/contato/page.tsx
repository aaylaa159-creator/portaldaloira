...
const WHATSAPP_URL =
  'https://wa.me/5565993546241?text=Ol%C3%A1%2C%20Portal%20da%20Loira!%20Gostaria%20de%20entrar%20em%20contato.';
    ...
    <>
      ...
      >
        ...
        <div className="not-prose">
          <ContactEmailModal channel="redacao" />
        </div>

        <h2>WhatsApp</h2>
        <p>
          Prefere falar pelo WhatsApp? Clique no botão abaixo para iniciar uma
          conversa direta com nossa equipe:
        </p>
        <p className="not-prose">
          <a
            ...
            className="inline-flex items-center gap-2 rounded-full bg-[#25D366] px-5 py-2.5 text-sm font-semibold text-white no-underline transition hover:bg-[#1ebe5d]"
            aria-label="Abrir conversa no WhatsApp com o Portal da Loira"
          >
            <WhatsAppIcon />
            Chamar no WhatsApp
          </a>
